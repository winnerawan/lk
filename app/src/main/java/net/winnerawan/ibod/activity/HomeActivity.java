...
import net.winnerawan.ibod.adapter.SecondAdapter;
import net.winnerawan.ibod.adapter.ThirdAdapter;
import net.winnerawan.ibod.app.AppConfig;
import net.winnerawan.ibod.fragment.AnimeFragment;
import net.winnerawan.ibod.fragment.SerialMoviesFragment;
import net.winnerawan.ibod.helper.SQLiteHandler;
import net.winnerawan.ibod.util.NotificationUtils;
