...
import net.winnerawan.layarkaca.model.MediaItem;
...
public class VideoPlayer extends AppCompatActivity implements HlsSampleSource.EventListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_url = new String[]{LINK_MOVIE,"http://api.layarkaca.wonderwall.biz.id/v1/next.mp4"};
