...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "layarkaca";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_EMAIL + " TEXT UNIQUE," + KEY_FOTO + " TEXT,"
                + KEY_AGE + " INTEGER,"
                + KEY_GENDER + " TEXT,"
                + KEY_LOCATION + " TEXT" + ")";
     ...
     * */
    public void addUser(String name, String email, String foto, int age, String gender, String location) {
