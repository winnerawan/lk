...
import net.winnerawan.wonderscreen.helper.DialogUtils;
import net.winnerawan.wonderscreen.helper.SQLiteHandler;
import net.winnerawan.wonderscreen.helper.SessionManager;
                ...
                new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        try {
                            ...
                            db = new SQLiteHandler(getApplicationContext());
                            db.addUser(profile.getName(), email, profile.getProfilePictureUri(200,200).toString(), 24 , gender, bday);
