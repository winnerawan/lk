...
import net.winnerawan.wonderscreen.adapter.MyAdapter;
import net.winnerawan.wonderscreen.adapter.SecondAdapter;
import net.winnerawan.wonderscreen.adapter.ThirdAdapter;
import net.winnerawan.wonderscreen.app.AppConfig;
import net.winnerawan.wonderscreen.fragment.AnimeFragment;
import net.winnerawan.wonderscreen.fragment.SerialMoviesFragment;
import net.winnerawan.wonderscreen.helper.SQLiteHandler;
import net.winnerawan.wonderscreen.util.NotificationUtils;
