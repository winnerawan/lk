...
import net.winnerawan.wonderscreen.fragment.AboutSerialFragment;
import net.winnerawan.wonderscreen.fragment.WatchSerialFragment;

import butterknife.Bind;
import butterknife.ButterKnife;

public class SerialMovieActivity extends AppCompatActivity {
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return new AboutSerialFragment();
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return new WatchSerialFragment();
                default:
