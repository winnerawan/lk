...
public class VideoPlayer extends AppCompatActivity implements HlsSampleSource.EventListener, View.OnClickListener {
    ...
    private String LINK_MOVIE, TITLE_MOVIE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LINK_MOVIE = bundle.getString("link");
        TITLE_MOVIE = bundle.getString("title");
        //getMovie(movie);
        Log.e(TAG, "video-->"+ movie);
        ...
        video_url = new String[]{LINK_MOVIE,"http://player.hungama.com/mp3/91508493.mp4"};
        Log.e(TAG, "video_url -->"+video_url[0]+" - "+video_url[1]);
        video_title = new String[]{TITLE_MOVIE,"Movie Trailer"};
    ...
    private void getMovie(int id) {
        ...
        api.getMovie(id, new Callback<Movie>() {
            ...
            public void success(Movie movie, Response response) {
                LINK_MOVIE = movie.getLink720();
                Log.e(TAG, "method getMovie --> "+movie.getLink720());
                TITLE_MOVIE = movie.getTitle();
            }
